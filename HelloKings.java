...
2. Used in desktop applications
3. Used in web applications
4. Used in web servers and application servers
5. Used in games
6. Used in database connection

*/
public class HelloKings {
    public static void main(String[] args){
	System.out.print("|-----------------------------------|\n");
        System.out.print("|  Hellow Programming Kings         |\n");   // Using the \n ensures there is moving to a new line
